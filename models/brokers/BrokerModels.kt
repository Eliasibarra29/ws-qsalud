...
data class ConceptoSG(
    ...
    @JsonProperty("ValConceptoSG") val valConceptoSG: Any?, // Puede ser Int, Double o String
...
data class Contratante(
    ...
    @JsonProperty("ComposicionAccionaria") val composicionAccionaria: Any?, // Simplificado para no alargar si no se requiere validación estricta interna
...
data class RecibosWrapper(
    @JsonProperty("Recibo") val recibo: Recibo? // Puede ser lista o un objeto dependiendo la póliza
)
